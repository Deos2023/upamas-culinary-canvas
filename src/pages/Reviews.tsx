...
const Reviews = () => {
  ...
  return (
    <main className="overflow-x-hidden">
      {/* Hero */}
      <section
        className="relative h-screen bg-gradient-to-br from-black/60 to-slate-700 bg-fixed bg-cover bg-center bg-no-repeat"
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Want to Be Our Next{" "}
            <span className="text-primary">Happy Client?</span>
          </h2>
