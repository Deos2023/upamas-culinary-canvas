...
import { Heart, Briefcase, Cake, Sparkles, Settings, Users, Check } from 'lucide-react';
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Professional catering solutions for all your business events',
      features: [
    ...
    },
    {
      ...
      description: 'Delightful food arrangements for birthday celebrations of all ages',
      features: [
    ...
    },
    {
      ...
      description: 'Traditional sattvik food options for religious ceremonies and pujas',
      features: [
    ...
    },
    {
      ...
      description: 'Authorized dealer for high-quality automatic roti making machines',
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive maintenance and repair services for roti machines',
      features: [
        'Regular maintenance',
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive catering and equipment solutions for every occasion
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              What makes Upama's Kitchen the preferred choice for catering in Kolkata
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-accent">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Get in touch with us today for a free consultation and customized quote
          </p>
